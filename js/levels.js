...
window.Levels = [
  {
    ...
    learn: "Vertical scaling: a single worker has hard limits. Upgrade its CPU (speed) and queue (buffer) to absorb more load.",
  ...
  },
  {
    ...
    learn: "Scale horizontally: add workers and let a load balancer distribute traffic, with health checks so dead workers stop receiving it.",
  ...
  },
  {
    ...
    learn: "Networks lose packets: ACKs confirm receipt, retries recover loss, and idempotency keys make redelivery safe.",
  ...
  },
  {
    ...
    learn: "Read replicas serve local reads fast, but replication lag means briefly stale data. Writes still go to the primary.",
  ...
  },
  {
    ...
    learn: "During a partition you must choose: AP stays available and reconciles later, or CP stays consistent and refuses writes.",
  ...
  },
  {
    ...
    learn: "Kubernetes-style orchestration: declare the desired replica count and the system heals itself when nodes die.",
